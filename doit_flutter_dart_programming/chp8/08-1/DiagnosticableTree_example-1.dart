...
// class Category with DiagnosticableTreeMixin { //with : mixin 구조 //DiagnosticableTreeMixin은 Flutter에서 객체의 속성을 트리 구조로 디버깅 로그에 출력할 수 있게 해줍니다.
//   final String name;
...
//   debugPrint(category.toStringDeep()); // 트리 구조로 출력 //toStringDeep()를 통해 계층 구조를 시각화.
// }
